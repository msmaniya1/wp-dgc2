	...
	function unicaevents_template_404_output() {
		...
		<article class="post_item post_item_404">
			<div class="post_content">
				...
				<p class="page_description"><?php echo wp_kses( sprintf( __('Can\'t find what you need? Take a moment and do a search below or start from <a href="%s">our homepage</a>.', 'unicaevents'), esc_url(home_url('/')) ), $UNICAEVENTS_GLOBALS['allowed_tags'] ); ?></p>
