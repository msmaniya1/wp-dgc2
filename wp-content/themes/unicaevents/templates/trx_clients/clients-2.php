				...
				<div class="sc_client_image"><?php echo trim($post_options['client_image']); ?>
					<div class="sc_client_hover">
						<div class="sc_client_info">
							<h5 class="sc_client_title"><?php echo ($post_options['client_link'] ? '<a href="'.esc_url($post_options['client_link']).'">' : '') . ($post_options['post_title'] ? $post_options['post_title'] : $post_data['post_title']) . ($post_options['client_link'] ? '</a>' : ''); ?></h5>
							<div class="sc_client_description"><?php echo trim(($post_options['client_position'] != 'inherit' ? $post_options['client_position'] : '')); ?></div>
						</div>
					</div>
				</div>
			</div>
