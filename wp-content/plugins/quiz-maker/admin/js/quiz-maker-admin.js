(function ($) {
    ...
    $(document).ready(function () {
        ...
        var checkCountdownIsExists = $(document).find('#ays-quiz-dicount-month-main-helloween');
        ...
        if ( checkCountdownIsExists.length > 0 ) {
            ...
            // var countdownEndTime = quizLangObj.quizBannerDate,
            var countdownEndTime = "OCT 31, 2022 23:59:59",
